    ...
    <div className="home-placeholder">
      <div className="placeholder-content">
        <div className="brand-logo">
           <img src="/logo.png" alt="BIT CHATHUB" width="120" height="120" style={{ borderRadius: '24px', opacity: 0.8 }} />
        </div>
        <h1>BIT CHATHUB for Windows</h1>
      ...
      <div className="encryption-footer">
        ...
        <span>Your messages are end-to-end encrypted with BIT CHATHUB SECURE</span>
      </div>
    </div>
  );
};
