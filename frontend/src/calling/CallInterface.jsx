        ...
        <div className="call-overlay">
            <div className="call-container">
                ...
                <div className="call-info">
                    ...
                    {isMuted && (
                        <div className="mute-badge" style={{marginTop: '10px', background: 'rgba(239, 68, 68, 0.2)', color: '#ef4444', padding: '4px 12px', borderRadius: '20px', fontSize: '12px', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '5px'}}>
